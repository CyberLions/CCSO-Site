...
.calendar-event-gbm {
    background: url('@/assets/images/gbm.png');
    flex: 1 1 calc(64% - 32px);
}
.calendar-event-social {
    background: url('@/assets/images/gbm_sdr_photo.jpg');
}
.calendar-event-red {
    background: url('@/assets/images/lockpicking_working_gbm.jpg');
}
.calendar-event-blue {
    background: url('@/assets/images/ccdc_working_2025.jpg');
}
.calendar-event-comp {
    background: url('@/assets/images/competitions.png');
}
